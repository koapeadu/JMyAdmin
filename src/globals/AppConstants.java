...
public interface AppConstants {
	...
	int PROGRAM_WIDTH = (int) Toolkit.getDefaultToolkit().getScreenSize().getWidth()*3/4;
	int PROGRAM_HEIGHT = (int) Toolkit.getDefaultToolkit().getScreenSize().getHeight()*3/4;
}
